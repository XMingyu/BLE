...
#define DEFAULT_ADVERTISING_INTERVAL          160       // 160广播间隔， 数值越大功耗越低但是广播的包的时间间隔就太长
...
#define DEFAULT_ENABLE_UPDATE_REQUEST         FALSE//FALSE//TRUE  // 阿莫着重提醒： 这个是参数更新使能， 这里最好设置成FALSE， 否则android4.4的手机app 连接上后几秒钟后短线， 暂时用此方法解决， 应该是android 兼容问题， 后面有新的解决方法，再公告给大家， 2015 07 11 ，，amomcu 阿莫
...
static uint8 scanRspData[] =
{
  ...
  GAP_ADTYPE_LOCAL_NAME_COMPLETE,   // 广播本地名称， 你在手机app上看到的是这个名字
  'B',
  'a',
  'b',
  'a', 
...
// GAP GATT Attributes
static uint8 attDeviceName[GAP_DEVICE_NAME_LEN] = "Babacloud Piano";   // 这个就是蓝牙设备名称
#define DEFAULT_DEVICE_NAME  "Babacloud Piano"
...
void SimpleBLEPeripheral_Init( uint8 task_id )
{
  ...
  // Set the GAP Characteristics
     ...
     GGS_SetParameter( GGS_DEVICE_NAME_ATT, GAP_DEVICE_NAME_LEN, attDeviceName );//mx-change -20167-27
...
*/
  ...
  #endif // HAL_IMAGE_A
#else
  HalLcdWriteString( "BabaCloud Piano", HAL_LCD_LINE_1 );
#endif // FEATURE_OAD
